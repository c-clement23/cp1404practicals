...
class ProgrammingLanguage:
    ...
    def __init__(self, name, typing, reflection, year, pointer_arithmetic):
        """Construct a ProgrammingLanguage from the given values, which includes pointer arithmetic support"""
        self.name = name
        self.typing = typing
...
def run_tests():
    """Run simple tests/demos on ProgrammingLanguage class, which includes pointer arithmetic field"""
